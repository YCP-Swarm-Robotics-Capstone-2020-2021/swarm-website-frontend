        ...
        if(this.props.currentUser.accountLevel === 0){
            editTabElements =
                <Tab eventKey="edit" title="Edit" transition={false}>
                    <EntryEditForm initHeadingData={this.state.headings} headingEditElements={this.state.headingEditElements} entryData={this.state.data} sideBarData={this.state.sideBar} currentUser={this.props.currentUser} wiki={this.props.wiki}></EntryEditForm>
                </Tab>;
        }
        return(
